...
class UserDetailsController extends AbstractController
{
     ...
     */
    public function index(UserDetailsRepository $userDetailsRepo): Response
    {
        return $this->render('user_details/index.html.twig', [
            'user_details' => $userDetailsRepo->findAll(),
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="user_details_delete", methods={"POST"})
     */
